...
export const S07_PASSPHRASE_SEARCH_CONTENT_VERSION = '2.3.0';

export const s07PassphraseSearchContent = {
  version: S07_PASSPHRASE_SEARCH_CONTENT_VERSION,
  source: {
    revision:
      'Userauftrag vom 2026-08-13 · PassWo-orientierter Abschluss der fiktiven Search-Ergebnisse',
    copyReference:
      ...
      results: [
        {
          ...
          description:
            'Erstelle aus zufällig ausgewählten Wörtern eine lange, gut merkbare Passphrase und passe Trennzeichen sowie Wortanzahl an.',
        },
        {
          id: 'wortanker',
          siteName: 'Wortanker',
